...
- Location: tests/e2e/manifest-pages.spec.ts:125:5
...
Locator: getByText('Features').first()
Expected: visible
Timeout: 30000ms
...
Call log:
  ...
  - waiting for getByText('Features').first()
...
- main:
  ...
  - paragraph: Overzicht van uw softwarecatalogus en configuraties
  - button "Vernieuwen"
  - note:
    - heading "Beheer van Organisaties" [level=3]
    - paragraph: Organisaties kunnen worden geaccepteerd en beheerd via de organisaties pagina. Het aanmaken en bewerken van gebruikers gaat ook via de organisatie pagina, omdat deze onderdeel zijn van organisaties.
    - button "Ga naar Organisaties"
  - text: "Laatst bijgewerkt: 06/06/2026, 13:12"
  - table:
    - rowgroup:
      - row "Object Type Aantal Beheren":
        - columnheader "Object Type"
        - columnheader "Aantal"
        - columnheader "Beheren"
    - rowgroup
  - text: "Laatst bijgewerkt: 06/06/2026, 13:12"
  - table:
    - rowgroup:
