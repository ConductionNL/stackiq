...
class RenameDutchCatalogColumns implements IRepairStep {
	...
	private const COLUMN_MAP = [
		...
		'aanbevolen_voor_referentiecomponent' => 'recommended_for_referentiecomponent',
		'aanbieder' => 'provider',
		'afnemer' => 'consumer',
		...
		'datum_einde_ondersteuning' => 'date_end_ondersteuning',
		'datum_in_gebruik' => 'date_in_gebruik',
		'datum_in_ontwikkeling' => 'date_in_development',
		'datum_teruggetrokken' => 'date_teruggetrokken',
		'deelnemers' => 'participants',
		'depublicatiedatum' => 'depublication_date',
		'document_referentie' => 'document_reference',
		'documentation-lang' => 'documentation_long',
		'dpia_volgende_beoordeling' => 'dpia_volgende_assessment',
		'eigenaar' => 'owner',
		'eind_datum' => 'end_date',
		'eol_bijgewerkt_op' => 'eol_updated_on',
		'eol_bron' => 'eol_source',
		'functie' => 'role',
		'gebruikt_voor_referentiecomponenten' => 'gebruikt_for_referentiecomponenten',
		'gegevensuitwisseling_richting' => 'gegevensuitwisseling_direction',
		'gekoppelde_standaard_versies' => 'gekoppelde_standard_versions',
		'gemma-ggm_status' => 'gemma_ggm_status',
		'gemma-toelichting' => 'gemma_notes',
		'geplande_vervanging' => 'planned_replacement',
		'geplande_vervangings_datum' => 'planned_vervangings_date',
		'gerealiseerd_met_intermediair_module' => 'gerealiseerd_with_intermediair_module',
		'geregistreerd_door' => 'geregistreerd_by',
		'ggm-bron' => 'ggm_source',
		...
		'start_datum_uit_gefaseerd' => 'start_date_out_gefaseerd',
		'start_datum_uit_te_faseren' => 'start_date_out_te_faseren',
		'start_datum_verwerving' => 'start_date_verwerving',
		'toelichting' => 'notes',
		'type_voorziening' => 'type_provision',
		'verplichte_standaarden' => 'verplichte_standards',
		'verplichte_voor_referentiecomponent' => 'verplichte_for_referentiecomponent',
		'versie' => 'version',
