...
- [ ] 0.1 Verify no new capability duplicates existing OpenRegister services:
...
- [ ] 0.2 Capture current PHPMD suppression baseline:
...
- [ ] 0.4 Verify `composer check:strict` script exists and runs PHPMD, PHPCS,
