...
# Frontend Settings UI Specification

## Purpose

Captures the observed behavior of the admin/settings UI: the settings shell and each configuration section (OpenRegister integration, user groups, email, cronjob, organization sync, ArchiMate import/export, statistics, version) plus the navigation configuration panel.
