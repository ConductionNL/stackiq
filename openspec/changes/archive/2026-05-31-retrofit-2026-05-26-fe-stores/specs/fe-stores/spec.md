...
# Frontend Stores Specification

## Purpose

Captures the observed behavior of the Pinia store modules (settings, organisation, navigation, catalog), the shared object-operations store plugin, the theme helper service, and the heartbeat client utility.
