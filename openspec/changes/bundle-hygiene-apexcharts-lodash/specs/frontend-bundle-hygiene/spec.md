...
stackiq's own `package.json` MUST NOT declare a direct dependency
...
- GIVEN stackiq's `src/` tree contains no direct `apexcharts`
...
- GIVEN a developer wants to add a chart to stackiq
