...
Captures observed behavior of SymfonyEmailService — composing and sending the app's transactional notifications (organisation registration/activation, user creation/update/password) over a configurable Symfony Mailer transport, plus the transport-configuration getters/setters and test-send.

## ADDED Requirements

### REQ-001: The system SHALL send the app's transactional notification emails
...
### REQ-002: The system SHALL expose and persist the mail transport configuration
